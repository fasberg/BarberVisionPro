...
try:
    ...
    print(f"[!] КРИТИЧНА ПОМИЛКА: MediaPipe не знайдено. Виконайте 'pip install mediapipe'")
    raise ImportError("MediaPipe не встановлено у вашому середовищі Python.")
